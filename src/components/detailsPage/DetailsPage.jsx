...
const DetailsPage = () => {
    ...
    console.log(toy);
    return (
        <div className="mt-16 flex justify-center items-center gap-10 bg-ruby-500 bg-opacity-10 p-16 rounded-xl text-charcoal">
            ...
            <div className="w-full">
                <div className="flex justify-between items-center p-2">
                    <p className="text-3xl font-bold w-fit mt-5">{toy.toyName}</p>

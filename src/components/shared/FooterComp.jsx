...
const FooterComp = () => {
    return (
        <footer className="bg-gray-800 text-gray-200 py-16 px-5">
        <div className="container mx-auto flex flex-wrap justify-between">
            ...
            <div className="w-full md:w-auto mb-4 md:mb-0  mt-5 md:mt-0">
                <h4 className="text-xl font-bold mb-2">Contact Us</h4>
                <p>Email: hero@haven.com</p>
            ...
            <div className="w-full md:w-auto mt-5 md:mt-0">
                ...
                <p>456 Dummy Avenue</p>
                <p>Fictional City, FA 12345</p>
                <p>Fake Country</p>
            </div>
        </div>
        <div className="container mx-auto mt-4 text-center">
            <p>&copy; {new Date().getFullYear()} Hero Haven. All rights reserved.</p>
        </div>
    </footer>
    );
};

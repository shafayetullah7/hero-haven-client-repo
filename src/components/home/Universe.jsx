...
const Universe = () => {
    ...
    return (
        <div className="md:px-32">
            <h1 className="text-5xl text-charcoal font-bold text-center">Visit Different <span className="text-metalicGold text-6xl bg-base-200 px-5 py-2 rounded-xl">Universes</span></h1>
            <div className="mt-16">
                ...
                >
                    <div className="w-3/4 h-[350px] md:h-fit shadow-xl">
                ...
                <div className="flex flex-col md:flex-row gap-10 md:gap-20 justify-between items-center mt-5"
